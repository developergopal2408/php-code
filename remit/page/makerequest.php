                            ...
                            <form class="form-horizontal" role="form" action="" method="post" name="remit" id="remit">
                                <div class="col-sm-6 ">
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-xs-6">
                                            <input type="text" maxlength="16" class="form-control" name="remit_no" id="remit_no" placeholder="Enter Remit Number" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-xs-6">
                                            <select name="rcompany" id="rcompany" class="form-control select2" required >
                                                ...
                                                while ($rcom = odbc_fetch_array($sql)) {
                                                    ?>
                                                    <option value="<?php echo $rcom['RemitName']; ?>" ><?php echo $rcom['RemitName']; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select> 
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-xs-6">
                                            <input type="text" class="form-control" name="rname" id="rname" placeholder="Enter Receiver Name" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-xs-6">
                                            <input type="text" class="form-control" name="rfname" id="rfname" placeholder="Enter Receiver Father Name" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-xs-6">
                                            <input type="text" class="form-control" name="raddress" id="raddress" placeholder="Enter Receiver Address" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-xs-6">
                                            <input type="text" class="form-control" name="district" id="district" placeholder="Enter Receiver District" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-xs-6">
                                            <select name="sidtype" id="sidtype" class="form-control select2" required >
                                                ...
                                                while ($sid = odbc_fetch_array($sql1)) {
                                                    ?>
                                                    <option value="<?php echo $sid['IdentityType']; ?>" ><?php echo $sid['IdentityType']; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select> 
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-xs-6">
                                            <input type="text" maxlength="10" class="form-control" name="issue" id="issue" placeholder="Enter ID ISSUE DATE" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-xs-6">
                                            <input type="text" maxlength="15" class="form-control" name="idno" id="idno" placeholder="Enter ID Number" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-xs-6">
                                            <input type="text" maxlength="10" class="form-control" name="dob" id="dob" placeholder="Enter DOB Date" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-xs-6">
                                            <input type="text" maxlength="10" class="form-control" name="rcontact" id="rcontact" placeholder="Enter Receiver Contact Number" required>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-xs-6">
                                            <input type="text" class="form-control" name="sname" id="sname" placeholder="Enter Sender Name" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-xs-6">
                                            <input type="text" maxlength="10" class="form-control" name="scontact" id="scontact" placeholder="Enter Sender Contact Number" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-xs-6">
                                            <input type="text" class="form-control" name="country" id="country" placeholder="Enter Sender Country" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-xs-6">
                                            <input type="text" class="form-control" name="expamount" id="expamount" placeholder="Enter Expected Amount" required>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12" style="margin-top:7px;">
                                    <div class="col-xs-6 pull-right">
                                        <button type="button" id="claim" name="claim"  class="btn btn-md btn-block btn-primary" style="margin-bottom:10px;" data-toggle="modal" data-target="#confirm-submit">Submit</button>
                                    </div>
                        ...
                        <div class="modal-content">
                            <form name="remit" id="remit" class="form-inline" role="form" action="remitprocess.php" method="post">
                                ...
                                <div class="modal-footer">
                                    <input type="submit" id="submit" name="submit" class="btn  btn-primary  pull-left" data-dismiss="modal" value="Send">
