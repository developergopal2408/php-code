...
<script>
    ...
    $('#staff[data-href]').on("click", function () {
        document.location = $(this).data('href');

    });

    $('#upstaff[data-href]').on("click", function () {
        document.location = $(this).data('href');

    });

    $('#edit[data-href]').on("click", function () {
        document.location = $(this).data('href');
    ...
    $(document).ready(function () {
        $('#edits').on('click', function () {
            ...
            if ($("select option:selected").index() > 0) {
                ...
                //$(remitCompany).text($('#rcompany').val());
            } else {
    ...
    $('#Update[data-href]').on("click", function () {
        document.location = $(this).data('href');
    });

    $('#Updates[data-href]').on("click", function () {
        document.location = $(this).data('href');
    });
