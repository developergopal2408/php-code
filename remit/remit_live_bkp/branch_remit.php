    ...
    <div class="container" >
        ...
        <div class="row" ><!--Start of row-->
            ...
            if (isset($_POST['remit'])) {
                ...
                if (empty($remitno) or empty($amount)) {
                    ...
                    $sql = "INSERT INTO remittancedetail(RemitID,branchId,Savedate,Amount,STAFFID,REMITNO,STATUS) VALUES ('$remitId','$branchId','$cdate','$amount','$staffid','$remitno','0')";
            ...
            <div class="row" style="margin-top:10px;">
				...
				<div class="pull-left">
                        <h4 class="text-primary">
                            ...
                            Remittance Payment Made by Branch
                    ...
                    <div class="pull-right">
                        ...
                        <button id="excel" class="btn btn-xs  btn-success " href="#" onClick ="$('#payremit').tableExport({type: 'excel', escape: 'false'});">XLS</button>
                ...
                <div class="col-md-12">
                    ...
                    <div class="responsive-table">
                        ...
                        <table id="payremit" class="table table-striped  table-bordered data-table table-condensed table-hover" style="font-size: 12px; ">
                                ...
                                while ($row = mysqli_fetch_assoc($res)) {
                                    ...
                                    <tr>
                                        ...
                                        if ($categoryID != '1') {
                                            ?>
                                            <td>
                                                 <?php if($categoryID == '3' AND $_SESSION['JOBTYPEID'] != '3'){
                                                    if ($status == '0') {
                                                    ?>
                                                
                                                <button id="edit" class="btn btn-xs btn-primary" data-href="edit_remit_staff.php?detailid=<?php echo $detailid; ?>">EDIT</button>
                                                    <?php }else{?>
                                                        <button id="edit" class="btn btn-xs btn-primary" data-href="edit_remit_staff.php?detailid=<?php echo $detailid; ?>" disabled>EDIT</button>
                                                ...
                                                if ($_SESSION['POSITION'] == 'Branch Incharge' or $_SESSION['POSITION'] == 'Area Incharge' or $_SESSION['IS_APPROVED_BY'] == '1') {
                                                    ?>
                                                    <button id="Updates" class="btn btn-xs btn-danger" data-href="update_branch_status.php?detailid=<?php echo $detailid; ?>">UPDATE</button>
                                                    <?php
                                                }
                                                ?>
