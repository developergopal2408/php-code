...
$date = date('Y-m-d');
$sql = mysqli_query($con,"UPDATE `remittance` SET PAIDAMT='$amount',STATUS='APPROVED',REASON='$comment',TRANSACTIONCODE='$transaction_code',PAIDDATE='$date' where MSGID='$msg_id'"); 
