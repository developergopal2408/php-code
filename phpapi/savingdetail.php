...
$query = "select SavingTypeID, AccountNo,(select SavingType From SavingType where SavingTypeID = SavingDetail.SavingTypeID)SavingType,sum(CrAmount - DrAmount)Balance
		 from SavingDetail where OfficeID = '$OfficeID' and MemberID = '$MemberID' and SavingTypeID != 1 
		 group by SavingTypeID,AccountNo"; 
