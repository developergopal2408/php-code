    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <?php
                $b = sqlsrv_query($connection,"select Name from officedetail where ID = '$oid'");
                $run = sqlsrv_fetch_array($b);
                echo $run['Name'];
                
                $m = sqlsrv_query($connection,"select FirstName,LastName from member where MemberID = '$mid' and OfficeID='$oid'");
                $rum = sqlsrv_fetch_array($m);
                        ...
                        <div class="box-body">
                            <table id="ladetail" class="display table table-condensed table-bordered table-striped" style="width: auto;">
                                ...
                                <tbody class="text-sm" style="font-size:10px;">
                                    <?php
                                    $qry = "select * from analysisloan where memberid='$mid' and officeid = '$oid'";
...
if (isset($_POST['search'])) {
    echo $bname . ' -  Loan Analysis Detail ( ' . $_POST['date1'] . ' - ' . $_POST['date2'] . ')';
} else {
    echo $branchName . "- Loan Analysis Detail ";
};
?>',
            },
            {
                ...
                messageTop: '<?php
if (isset($_POST['search'])) {
    echo $bname . "- Loan Analysis Detail";
} else {
    echo $branchName . "- Loan Analysis Detail ";
};
?>',
            },
            {
                ...
                messageTop: '<?php
if (isset($_POST['search'])) {
    echo '<h5 class="text-bold text-center"> ' . $bname . ' <br/> Loan Analysis Detail <br/>  ' . $_POST['date1'] . ' - ' . $_POST['date2'] . ' </h5>';
} else {
    echo $branchName . "<br/> Loan Analysis Detail ";
};
?>',
