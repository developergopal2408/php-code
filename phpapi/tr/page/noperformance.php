...
if (isset($_POST['checkboxes'])) {
    foreach ($_POST['checkboxes'] as $uid) {
        ...
        if ($bulk_option == '1') {
            ...
            $bulk_author_run = sqlsrv_query($connection, $bulk_author_query);
                        ...
                        <table id="performance" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                while ($row = sqlsrv_fetch_array($result)) {
                                    ...
                                    $result2 = sqlsrv_query($connection, $sql2);
                                    $rowo = sqlsrv_fetch_array($result2);
                                    $ocode = $rowo['Code'];
                                    $oname = $rowo['Name'];

                                    $sql3 = "select * from StaffPosition where PositionId = '$pid'";
                                    $result3 = sqlsrv_query($connection, $sql3);
                                    $rowp = sqlsrv_fetch_array($result3);
