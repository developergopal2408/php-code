                ...
                <div class="col-md-12">
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            <div class="col-sm-12">
                                ...
                                <div class="box-tools pull-right" >
                                    <a href="registered_member.php"  class=" btn btn-flat bg-blue" title="Refresh"><i class="fa fa-refresh"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            ?>
                            <table id="rmember" class="stripe row-border order-column" cellspacing="0" width="100%">
                                ...
                                <tbody class="text-sm">
                                    ...
                                    if (isset($_POST['search'])) {
                                        $qry = "select (m.membercode)Code,m.Firstname+' '+M.lastname as MemberName,(m.Regdate)Regdate,
                                                m.DOB,m.Spousefather,m.FatherInLaw,(z.Zonename)Zone,(d.districtname)District,(v.vdcname)VDC,m.WardNo
                                    ...
                                    $results = odbc_exec($connection, $qry);
