                ...
                <div class="col-md-12">
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            <div class="col-sm-12">
                                ...
                                <div class="box-tools pull-right" >
                                    <a  href="daybook.php"  class="btn btn-flat bg-blue" data-toggle = "tooltip" title="All / Refresh"><i class="fa fa-refresh"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <table  id="daybook" class="stripe row-border order-column" cellspacing="0" width="100%">
