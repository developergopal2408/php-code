    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-solid">
                ...
                <div class="box-body">
                    <h5 class="text-bold text-center"><?php echo "Performance List Of ". $fym ; ?></h5>
                    <table id="performance" class="display">
                            ...
                            while ($row = odbc_fetch_array($result)) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php
                                        $sql = "select * from SalaryAllowance where YearMonth = '$fym' AND StaffID = '" . $row['staffid'] . "' AND IsAllowable = '0'";
        ...
        buttons: [
            {
                ...
                message: 'Performance Report - <?php echo $fym; ?>',
