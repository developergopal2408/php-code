...
$query = "select o.code,o.name, a.SaveDate, sum(a.loandr) loandr, sum(a.LoanCr)pri, sum(a.IntCr)int ,sum(a.pridue)pridue, sum(a.intdue)intdue 
from officedetail o, LoanDetail a 
