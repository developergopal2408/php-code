    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Profit & Loss Detail</li>
            </ol>
        </section>
        <!-- Main content -->
                ...
                <div class="col-md-12">
                    <div class="box box-danger">
                        ...
                        <div class="box-body">
                            ...
                            ?>
                            <table id="ladetail" class="display table table-condensed table-bordered table-striped  text-sm">
                                <thead class="bg-red">
                                    <tr>
                                        <th>LF</th>
                                        <th>Name</th>
                                ...
                                <tbody>
                                    ...
                                    if (isset($_POST['search'])) {
                                        $qry = "select a.LF,a.Name,
                                                (select ISNULL((sum(dramount-cramount)),0)from ledger where ldate between'$sdate' and '$cdate' and  a.groupid = 4 and accountheadid=a.id $idw)Dr,
                                                (select ISNULL((sum(cramount-dramount)),0)from ledger where ldate between'$sdate' and '$cdate' and a.groupid = 5 and accountheadid=a.id $idw)Cr
                                    ...
                                    while ($res = odbc_fetch_array($result)) {
                                        if($res['Dr'] > 1 or $res['Cr'] > 1){
                                        ?>
                                        <tr>
                                            <td><?php echo $res['LF']; ?></td>
                                            <td><?php echo $res['Name']; ?></td>
                                            <td><?php echo $res['Dr']; ?></td>
                                            <td><?php echo $res['Cr']; ?></td>
                                        </tr>
                                        <?php
                                        }
                                    }
...
<script>
    $('#ladetail').DataTable({
        ...
        buttons: [
            {
                extend: 'excel',
                filename: 'Profit & Loss Detail',
                title: 'Jeevan Bikas Samaj',
                messageTop: '<?php
if (isset($_POST['search'])) {
    echo $bname . ' -  Profit & Loss Detail ( ' . $_POST['date1'] . ' - ' . $_POST['date2'] . ')';
} else {
    echo $branchName . "- Profit & Loss Detail ";
};
?>',
            },
            {
                ...
                messageTop: '<?php
if (isset($_POST['search'])) {
    echo '<h5 class="text-bold text-center"> ' . $bname . ' <br/> Profit & Loss Detail <br/>  ' . $_POST['date1'] . ' - ' . $_POST['date2'] . ' </h5>';
} else {
    echo $branchName . "<br/> Profit & Loss Detail ";
};
?>',
