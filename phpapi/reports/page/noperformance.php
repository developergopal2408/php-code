                ...
                <div class="box-body">
                    <form class="form-inline" action="" method="post">
                        ...
                        if (isset($_POST['search'])) {
                            ...
                            echo "<span class='text-red text-bold pull-right'>Performance Not Allowed List of ". $fym1 ."</span>";
                        }
                        ?>
                        <hr>
                            ...
                            <thead class="bg-red text-sm">
                                <tr>
                                    ...
                                    if (isset($_POST['search'])) {
                                        ...
                                        ?>
                                        <th>Performance नपाउने &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="checkbox" id="selectallboxes" data-toggle = "tooltip" title="नपाउने"></th>
                                        <?php
                                    }
                                    ?>
                                </tr>
        ...
        buttons: [
            {
                ...
                message: 'Performance  नपाउने  StaffList - <?php echo $fym1; ?>',
