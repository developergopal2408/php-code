                    ...
                    <div class="box box-danger">
                                    ...
                                    <div class=" form-group-sm">
                                        ...
                                        <div class="col-sm-3">
                                            <select name="id" id="id" class="form-control select2" required>
                                                ...
                                                <?php
                                                $query = "SELECT ID,Name,LF FROM acctree WHERE parentid = '272'";
                                                ...
                                                while ($p = odbc_fetch_array($sub)) {
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $p['ID']; ?>" ><?php echo $p['Name'] . " - (" . $p['LF'] . " )" ?></option>;
                                                    <?php
                                                }
                                                ?>
                                            </select>
                        ...
                        <div class="box-body">
                            <div class="box-title with-header text-bold">
                                ...
                                <?php
                                if (isset($_POST['id'])) {
                                    $query = "SELECT ID,Name FROM acctree  WHERE parentid = '272' AND  ID = '" . $_POST['id'] . "'";
                            ...
                            <table id="voucher" class="table table-responsive table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    if (empty($_POST)) {
                                        ...
                                        $qry = "select '$sdate' as Date,'0B/F' as Vno,'Brought Forward' as Description,DrAmount=CASE when 
                                               ...
                                               where a.id=l.accountheadid and l.ldate>='2074/04/01' and l.ldate < '$sdate' and a.parentid=272
                                               ...
                                               where a.id=l.accountheadid and l.ldate >='$sdate' and l.ldate <= '$cdate' and a.parentid=272
                                        ...
                                        while ($res = odbc_fetch_array($result)) {
                                            ...
                                            $bal = $bal + ($res['CrAmount'] - $res['DrAmount']);
                                            ?>
                                            <tr class="text-sm" style="cursor:pointer;">
