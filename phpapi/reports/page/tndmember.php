                            ...
                            <table id="trial" class="table table-bordered table-striped" bordered="1"> 
                                <thead class="bg-red" >
                                    <tr>
                                        <th>Office Code</th>
                                        <th>Office Name</th>
                                        <th>No of New Member</th>
                                        <th>Dropout of the Period</th>
                                        <th>Net Growth</th>
										<th>Dropout_among_new_member</th>
                                ...
                                if (empty($_POST)) {
                                    ...
                                    $tnm = 0;
                                    $total = 0;
									$Dropout_among_new_member = 0;
                                    $qry = "select o.code,o.name,
(select count(memberid) from member where regdate>='$sdate' and regdate<='$cdate' and officeid=o.id and catid<>3 )NewAddMember,
...
(select count(memberid) from member where regdate>='$sdate' and regdate<='$cdate' and officeid=o.id and Status='DROPOUT')Dropout_among_new_member
from  officedetail o
...
order by o.code";
                                    ...
                                    <tbody>
                                        ...
                                        if (odbc_num_rows($result) > 0) {
                                            while ($res = odbc_fetch_array($result)) {
                                                ...
                                                $total += $netmem;
												$Dropout_among_new_member += $res['Dropout_among_new_member'];
                                                ?>
                                                <tr>
													...
													<td><?php echo $res['Dropout_among_new_member']; ?></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
                                        ...
                                        <tfoot  class="bg-red text-bold">
                                            <tr>
												...
												<td><?php echo $Dropout_among_new_member; ?></td>
                                            </tr>
                                        </tfoot>
                                        <?php
                                    }
                                    ...
                                    if ($ID == "all") {
                                        $qry = "select o.code,o.name,
                                                (select count(memberid) from member where regdate>='$date1' and regdate<='$date2' and officeid=o.id and catid<>3)NewAddMember,
												...
												(select count(memberid) from member where regdate>='$date1' and regdate<='$date2' and officeid=o.id and Status='DROPOUT')Dropout_among_new_member
                                                from  officedetail o
                                                where ID not in(1,51,52,53,54,55,57,61,80,81,82)
                                                group by o.code,o.name,o.id
                                                order by o.code";
