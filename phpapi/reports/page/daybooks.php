                                    ...
                                    <div class=" form-group-sm">
                                        ...
                                        <div class="col-sm-3">
                                            <select name="id" id="id" class="form-control select2"  required>
                                                ...
                                                <option value="Saving" >Saving Detail</option>
                                                <option value="Loan">Loan Detail</option>
                                                <option value="Insuarance"  >Insurance & Income Detail</option>
                                            </select>
                                        </div>
...
(select sum(dramount)from savingdetail where savedate = '$date1'  and c.centerid=centerid and savingtypeid=1 and officeid=c.officeid and TransType <> 'Interest' and RefType <> 'Interest')welDr,
...
(select sum(dramount)from savingdetail where savedate = '$date1'  and c.centerid=centerid and savingtypeid=2 and officeid=c.officeid and TransType <> 'Interest' and RefType <> 'Interest')ComDr,
...
(select sum(dramount)from savingdetail where savedate = '$date1'  and c.centerid=centerid and savingtypeid=3 and officeid=c.officeid and TransType <> 'Interest' and RefType <> 'Interest')PerDr,
...
(select sum(dramount)from savingdetail where savedate = '$date1'  and c.centerid=centerid and savingtypeid=4 and officeid=c.officeid and TransType <> 'Interest' and RefType <> 'Interest')SpeDr,
...
from centermain c where c.officeid='" . $_SESSION['ID'] . "'  
group by c.centercode,c.centerid,c.officeid order by c.centercode";
                                        } else if ($ID === 'Loan') {
                                            $query = "select c.centercode,(select sum(loancr) from loandetail where savedate = '$date1'  and c.centerid=centerid and loantypeid=1 and officeid=c.officeid)GenCr,
