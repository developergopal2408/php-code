...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <i class="fa fa-folder-open"></i> <?php echo $branchName;?>
                <small>List OF Folders</small>
            </h1>
            <ol class="breadcrumb">
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body no-padding">
                            <ul class="nav nav-pills nav-stacked">
                                <li>
                                    <a href="view_uploaded_files.php"><i class="fa fa-folder-o"></i> All Files
                                        <span class="label label-primary pull-right">
                                            ...
                                            if ($BranchID == 1) {
                                                ...
                                                $qrys = mysqli_query($con, "select Document_Type from document where ToBranchID IN( '0','$BranchID') AND Document_Type != 'Circular' ");
                                            }
                                ...
                                if ($BranchID == 1) {
                                    ...
                                    $sql = mysqli_query($con, "select * from document where ToBranchID IN( '0','$BranchID') AND Document_Type != 'Circular' group by Document_Type");
                                }
                                while ($run = mysqli_fetch_array($sql)) {
                                    ...
                                    <li>
                                        <a href="view_uploaded_files.php?dtype=<?php echo $dt; ?>"><i class="fa fa-folder-o"></i> 
                                            <?php echo $run['Document_Type']; ?>
                                            <span class="label label-primary pull-right">
                                                <?php
                                                if ($BranchID == 1) {
                                                    $qry = mysqli_query($con, "select Document_Type from document  Where Document_Type = '$dt'");
                                                } else {
                                            $qry = mysqli_query($con, "select Document_Type from document  Where Document_Type = '$dt' AND ToBranchID IN( '0','$BranchID') AND Document_Type != 'Circular'");
                                                }
                                ...
                                <table id="detail" class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        if ($doctype AND $BranchID == 1) {
                                            $sol = mysqli_query($con, "select * from document where Document_Type = '$doctype' AND Document_Type != 'Circular' order by Uploaded_Time Desc");
                                            $update = mysqli_query($con, "update document set Notify_Ho = '1' where Id = '$fid'");
                                        } else if ($doctype AND $BranchID > 1) {
                                            $sol = mysqli_query($con, "select * from document where Document_Type = '$doctype' AND ToBranchID IN( '0','$BranchID') AND Document_Type != 'Circular'  order by Uploaded_Time Desc");
                                            $update = mysqli_query($con, "update document set Notify_Ho = '1' where Id = '$fid'");
                                        } else if ($BranchID == 1) {
                                            $sol = mysqli_query($con, "select * from document where Document_Type != 'Circular' order by Uploaded_Time Desc");
                                            $update = mysqli_query($con, "update document set Notify_Ho = '1' where Id = '$fid'");
                                        } else {
                                            $sol = mysqli_query($con, "select * from document where ToBranchID IN( '0','$BranchID') AND Document_Type != 'Circular' order by Uploaded_Time Desc");
                                            $update = mysqli_query($con, "update document set Notify_Ho = '1' where Id = '$fid' ");
                                        }
                                        ...
                                        <tr id="row" class="<?php if($row['Notify_Ho'] == '1' AND $row['Update_Ho'] == '0'){echo 'bg-black';} ?>"  class="clickable-row text-sm" style="cursor:pointer;"  data-href="update_ho.php?id=<?php echo $row['Id']; ?>">
                                                    ...
                                                    <td class="mailbox-subject"><b><?php echo $row['StaffID']; ?></b> - <?php echo $row['Remarks']; ?>
                                                    </td>
