                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-danger">
                        ...
                        <div class="box-header with-border">
                         <a href="subledger-borrowing.php" class="btn bg-red">Back To Main</a>
                             <div class="box-tools pull-right" >
                                    <button id="excel" class="btn bg-blue" href="#" onClick ="$('#vouchers').tableExport({type: 'excel', escape: 'false'});">Export To Excel</button>
                             </div>
                        ...
                        <div class="box-body">
                            ...
                            <table id="vouchers" class="table table-responsive table-bordered table-striped">
                                <thead class="bg-red">
                                    <tr>
