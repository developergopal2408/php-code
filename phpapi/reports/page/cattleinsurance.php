                ...
                <div class="col-md-12">
                    <div class="box box-danger">
                        ...
                        <div class="box-body">
                            ...
                            ?>
                            <table id="cinsurance" class="table stripe row-border order-column" cellspacing="0" width="100%"> 
                                ...
                                <tbody class="text-sm">
                                    ...
                                    $date1 = $_POST['date1'];
                                    $total = 0.0;
                                    if ($_SESSION['BranchID'] == 1 or $_SESSION['StaffID'] == 16 or $_SESSION['StaffID'] == 15) {
                                        $idx = "";
                                    } else {
