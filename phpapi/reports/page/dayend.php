                ...
                <div class="col-md-12">
                    <div class="box box-danger">
                        ...
                        <div class="box-body">
                            ...
                            <table id="dayend" class="table table-condensed table-bordered" > 
                                ...
                                <tbody>
                                    ...
                                    if (isset($_POST['search'])) {
                                        if ($ID == "all") {
                                            $qry = "select o.code,o.name,(a.Dayend)DayEndDate,
                                            (select sum(dramount-cramount)from ledger where o.id=officeid and ldate between'2075/04/01' and  max(a.dayend) and officeid=a.officeid
                                            and accountheadid=301)CashBalance,
                                            (select sum(dramount-cramount)from ledger where o.id=officeid and ldate between'2075/04/01' and  max(a.dayend) and officeid=a.officeid
                                            and accountheadid in(select accountid from bankname where officeid=ledger.officeid and categoryid in(306,307,308)))Bank,(a.UST)Times
                                            from officedetail o, Dayend a
                                            where o.id=a.officeid and a.dayend=(select max(dayend)from dayend where o.id=officeid)
                                            group by o.code,o.name,a.Dayend,o.id,a.officeid,a.UST
                                            order by o.code";
                                        } else {
                                            $qry = "select o.code,o.name,(a.Dayend)DayEndDate,
                                            (select sum(dramount-cramount)from ledger where o.id=officeid and ldate between'2075/04/01' and  max(a.dayend) and officeid=a.officeid
                                            ...
                                            and accountheadid in(select accountid from bankname where officeid=ledger.officeid and categoryid in(306,307,308)))Bank,(a.UST)Times
                                            from officedetail o, Dayend a
                                            where o.id=a.officeid and a.officeid = '$ID' and a.dayend=(select max(dayend)from dayend where o.id=officeid)
                                            group by o.code,o.name,a.Dayend,o.id,a.officeid,a.UST
                                            order by o.code";
                                        }
                                    }
