                ...
                <div class="col-md-12">
                    <div class="box box-danger">
                                            ...
                                            <div class="col-sm-3">
                                                <select name="id" id="id" class="form-control select2" >
                                                    ...
                                                    while ($rows = odbc_fetch_array($result)) {
                                                        ?>
                                                        <option value="<?php echo $rows['ID']; ?>" <?php if($rows['ID'] == $_POST['id']){echo "selected";}?>><?php echo $rows['Code'] . " - " . $rows['Name']; ?></option>;
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                        ...
                        <div class="box-body">
                            ...
                            ?>
                            <table id="memberpersonal" class="table table-responsive table-bordered table-striped" >
                                ...
                                <tbody class="text-sm" style="font-size:10px;">
                                    ...
                                    if (isset($_POST['search'])) {
                                        $qry = "select m.memberid,m.membercode,m.firstname+' '+m.lastname as MemberName,m.Photo,m.mSign,m.officeid,m.mobileno,
                                            m.Regdate,m.IsDisable,m.CitizenShipNo,m.gender,m.FatherName,m.GrandFatherName,
                                    ...
                                    while ($res = odbc_fetch_array($result)) {
										...
										<td><?php 
												...
												$str = odbc_exec($connection,"select * from officedetail where id = '".$res['officeid']."'");
												$off = odbc_fetch_array($str);
												echo str_ireplace("Branch Office","",$off['Name']);
												 //echo $res['mSign']; 
										...
										?></td>
											...
											if($res['Photo'] == true){
											?>
											<img id="myImg" src="memberphoto.php?img=<?php echo $res['Photo'];?>" class="img-circle"  width="50px" height="50px" alt="Photo Xa">
											<?php
											}else{
												echo "No Photo Update";
											}
											...
											if($res['mSign'] == true){
											?>
											<img  src="membersign.php?sign=<?php echo $res['mSign'];?>"  width="50px" height="50px" alt="Sign Xa">
											<?php
											}else{
...
$(function() {
    ...
    $('#memberpersonal').DataTable({
        ...
        paging: false,
        dom: 'Bfrtip', 
		columnDefs: [{ "width": "5%", "targets": [0,1,2] },{ "width": "10%", "targets": [3] }],
